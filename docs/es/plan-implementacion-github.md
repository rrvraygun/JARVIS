...
La fase 1 está implementada y validada con fixtures. GitHub Agent se puede
...
Estas herramientas no contactan GitHub, no leen contenido de archivos, no
guardan credenciales ni realizan escrituras.
...
2. Acciones Git locales: init, clonación, ramas, commit, pull y worktrees
   detrás de la revisión TUI de un solo uso.
